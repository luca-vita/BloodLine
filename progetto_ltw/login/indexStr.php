...
<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0 minimum-scale=0.9, maximum-scale=1.1">
        ...
        <script type="text/javascript" src="loginS.js" defer></script>
    ...
    <body>
        ...
        <section class="login">
        <form action="loginStr.php" name="loginS" method="POST">
            ...
            <div class="container">
                <div class="contact-form row">
                    ...
                    <div class="register">
                        <p>Non hai ancora un account? <a href="../signup/signStr.php">Registrati!</a></p>
                    </div>
                    </form>
                    <div>
